...
// callback management
	 ...
	 *					The function must match the return type and parameter list of this prototype:
	 *
	 *					void callback(int mouseX, int mouseY)
	 */
	 ...
	 *					The function must match the return type and parameter list of this prototype:
	 *
	 *					void callback(int mouseButton, int mouseX, int mouseY, int eventType)
	 */
	 ...
	 *					The function must match the return type and parameter list of this prototype:
	 *
	 *					void callback(int mouseX, int mouseY, int wheelRotation)
	 */
