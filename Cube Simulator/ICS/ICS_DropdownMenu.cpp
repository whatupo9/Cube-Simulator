	...
	_enabled(true)
{
	...
	// create a default color for the button
	ICS_Color blue(0, 0, ICS_COLOR_MAX);
	...
	setOptionColors(ICS_Color(ICS_COLOR_MAX, ICS_COLOR_MAX, ICS_COLOR_MAX), ICS_Color(ICS_COLOR_MIN, ICS_COLOR_MIN, ICS_COLOR_MAX), ICS_Color(ICS_COLOR_MIN, ICS_COLOR_MIN, ICS_COLOR_MAX));
	setOptionTextColors(ICS_Color(ICS_COLOR_MIN, ICS_COLOR_MIN, ICS_COLOR_MIN), ICS_Color(ICS_COLOR_MIN, ICS_COLOR_MIN, ICS_COLOR_MIN), ICS_Color(ICS_COLOR_MIN, ICS_COLOR_MIN, ICS_COLOR_MIN));
